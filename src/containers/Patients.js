...
export default function Patients(props) {
  ...
  const [firstnameFilter, setFirstnameFilter] = React.useState(false);
  const [lastnameFilter, setLastnameFilter] = React.useState(false);
  ...
  const openFiltersModal = (variant, text) => {
    alert()
  };
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell
                          ...
                          style={{ textAlign: 'center' }}
                          padding='none' >
                          <EmojiPeopleIcon style={{ cursor: 'pointer' }} onClick={() => props.openNurses(row.user_id, row.firstname + ' ' + row.lastname)} />
                        </TableCell>
                        <TableCell
                          component='th'
                          id={labelId}
                          ...
                          style={{ textAlign: 'center' }}
                          padding='none' >
                          <HailIcon  style={{ cursor: 'pointer' }} onClick={() => props.openUser(row.user_id, row.firstname + ' ' + row.lastname)} />
                        </TableCell>
                        <TableCell
                          component='th'
                          id={labelId}
                          ...
                          style={{ textAlign: 'center' }}
                          padding='none' >
                         <HealingIcon  style={{ cursor: 'pointer' }} onClick={() => props.openUser(row.user_id, row.firstname + ' ' + row.lastname)} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
